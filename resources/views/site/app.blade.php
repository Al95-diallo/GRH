        ...
        <div @if(!isset($demo)) class="container" @else class="container-fluid"
            ...
            <div class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    <li><a href="{{ route("features") }}">{{__('Caracteristique')}}</a></li>
                    <li><a href="{{ route("pricing") }}">{{__('Tarifs')}}</a></li>
                    <li><a href="{{ route("support") }}">{{__('Support')}}</a></li>
                    <li class="active outline">
                        <a href="{{ module_enabled('Subdomain')?route('front.workspace'):route('login') }}">{{__('Connectez-vous')}}</a>
                    </li>
                    <li class="active"><a href="{{ route('signup') }}">{{__('Inscription')}}</a></li>
                </ul>
            </div>
        </div><!--/.container-->
    </nav><!--/nav-->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route("support") }}">{{__('Contactez-nous')}}</a></li>
                    </ul>
                </div>
            </div><!--/.col-md-3-->
